...
> Runs git removing unlinked files
...
```shell
npm install grunt-git-remover --save-dev
```
...
## The "git-remover" task

### Overview
In your project's Gruntfile, add a section named `git-remover` to the data object passed into `grunt.initConfig()`.
...
## Release History
1.0.0 - First release, forked from grunt-git-status, compatible with grunt `~0.4.0`
